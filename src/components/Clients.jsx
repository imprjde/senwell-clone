...
export default function Clients() {
  ...
  return (
    <div className="bg-white   min-h-screen overflow-x-hidden">
      <div>
        <div className="mt-[50px] mb-[15px] space-y-10 md:space-y-20 ">
          <div
            className="text-[1.8rem] md:text-5xl md:font-normal font-semibold text-[#131022]"
            style={{ fontFamily: "Manrope, sans-serif" }}
          >
            Some of Our Premium Clients
          </div>
          <div className="container hidden md:flex pl-10 mx-auto  flex-col justify-center ">
            <Carousel images={logos} width={2} slidesToShow={4} />
          </div>
          <div className="container pl-10 mx-auto md:hidden flex flex-col justify-center ">
            <Carousel images={logos} width={2} slidesToShow={1} />
          </div>
        </div>
      </div>
      <div>
        ...
        <div className=" px-5 md:px-24 w-full">
          <div
            className="bg-[#F3F6FF]  flex-col md:flex-row mt-14 justify-between  space-x-0  md:space-x-20 py-[60px]  flex w-full m-auto md:px-16 space-y-5 md:space-y-0"
            style={{
              borderTopLeftRadius: "20px",
              borderBottomLeftRadius: "150px",
              borderTopRightRadius: "150px",
          ...
          >
            <div className=" flex min-w-[180px] space-y-3 md:space-y-0 flex-col">
              <span className="text-[#21aae4] font-bold text-[3.3rem]">
                {one}+
              </span>
              <span
            ...
            <div className=" bg min-w-[180px] space-y-3 md:space-y-0 flex flex-col ">
              <span className="text-[#21aae4] font-bold text-[3.3rem]">
                {two}%
              </span>
              <span
            ...
            <div className=" bg min-w-[180px] space-y-3 md:space-y-0 flex flex-col">
              ...
              <span
                className="font-[400] hidden md:flex text-[18px]  -mt-3 "
                style={{ fontFamily: "Manrope, sans-serif" }}
              >
                Team of passionate
                <br /> Engineers
              ...
              <span
                className="font-[400] text-[18px] md:hidden -mt-3 "
                style={{ fontFamily: "Manrope, sans-serif" }}
              >
                Team of passionate Engineers
              </span>
            </div>
            <div className="flex bg min-w-[180px] space-y-3 md:space-y-0 flex-col">
              <span className="text-[#21aae4] font-bold text-[3.3rem]">
                {four}+
              </span>
              <span
