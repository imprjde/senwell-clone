...
//   return (
//     <footer className="bg-[#131022] overflow-x-hidden  items-start  pt-5  text-white ">
//       <div className="md:flex m-auto mb-20  items-center justify-around">
//         <div className="flex items-center ">
//           <div className="pl-4 md:pl-28  space-y-4 X-X p-5 w-fit">
//             <div className=" text-left w-fit flex">
//               <span>
//                 <img className="w-[90px]" src={url} alt="" />
//               </span>
...
//         <div className="md:flex space-y-4 md:space-y-0 m-auto justify-between pl-4 md:pl-20 md:space-x-24 ">
//           <div className="">
//             <div className="text-left">
//               <div>
//                 <span
  ...
  return (
    <footer className="bg-[#131022] overflow-x-hidden  items-start  pt-5  text-white ">
      <div className="md:flex m-auto mb-20  items-center justify-around">
        ...
        <div className="md:flex space-y-4  md:pb-10 md:space-y-0 m-auto justify-between pl-4 md:pl-20 md:space-x-24 ">
          <div className="">
            <div className="text-left">
              <div>
                <span
      ...
      <div className="py-5 border border-x-0 border-b-0 border-t-gray-800">
        <div
          className="text-gray-600 font-semibold  text-[13px]"
          style={{ fontFamily: "Manrope, sans-serif" }}
        >
          @2024 | Privacy Policy | Senwell Group Private Limited | All rights
          reserved
