...
export default function Industries() {
  return (
    <div className="min-h-screen overflow-x-hidden w-full -mt-44 md:-mt-5 flex m-auto space-y-10 flex-col justify-center items-center ">
      <div className=" w-full">
        <span
          className="font-medium text-5xl text-[#0B2E58]"
          style={{ fontFamily: "Manrope, sans-serif", lineHeight: "4rem" }}
        >
          {" "}
          Industries We Serve
        </span>
      ...
      <div className="container md:hidden pl-10 mx-auto flex flex-col justify-center ">
        <Carousel images={images} width={350} slidesToShow={1} />
      </div>
    </div>
  );
}
